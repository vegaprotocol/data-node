...
var (
	testMarket1 = entities.Market{ID: entities.ID[entities.Market]("aa"), VegaTime: time.Unix(0, 1)}
	testMarket2 = entities.Market{ID: entities.ID[entities.Market]("bb"), VegaTime: time.Unix(0, 2)}
	testMarket3 = entities.Market{ID: entities.ID[entities.Market]("aa"), VegaTime: time.Unix(0, 3)}
	testMarket4 = entities.Market{ID: entities.ID[entities.Market]("cc"), VegaTime: time.Unix(0, 4)}

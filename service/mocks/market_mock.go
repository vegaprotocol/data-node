...
func (m *MockMarketStore) GetAllPaged(arg0 context.Context, arg1 string, arg2 entities.CursorPagination) entities.ConnectionData[*v2.MarketEdge,entities.Market] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllPaged", arg0, arg1, arg2)
	ret0, _ := ret[0].(entities.ConnectionData[*v2.MarketEdge,entities.Market])
	return ret0
}

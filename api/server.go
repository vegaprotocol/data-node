...
func NewGRPCServer(
	...
	notaryStore *sqlstore.Notary,
	multiSigSignerAddedStore *sqlstore.ERC20MultiSigSignerAdded,
	multiSigSignerRemoveStore *sqlstore.ERC20MultiSigSignerRemoved,
) *GRPCServer {
	// setup logger
	...
	return &GRPCServer{
		...
		multiSigSignerAddedStore:   multiSigSignerAddedStore,
		multiSigSignerRemovedStore: multiSigSignerRemoveStore,
...
func (g *GRPCServer) Start(ctx context.Context, lis net.Listener) error {
	...
	tradingDataSvcV2 := &tradingDataServiceV2{
		...
		marketDataStore:            g.marketDataStore,
		tradeStore:                 g.tradeStore,
		multiSigSignerAddedStore:   g.multiSigSignerAddedStore,
		multiSigSignerRemovedStore: g.multiSigSignerRemovedStore,
		notaryStore:                g.notaryStore,
		candleServiceV2:            g.candleServiceV2,
	}

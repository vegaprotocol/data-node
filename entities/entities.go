...
type PagedEntity[T proto.Message] interface {
	Market | Party | Trade | Order | MarginLevels | MarketData | Reward | Candle | Deposit | Withdrawal | Asset | OracleSpec | OracleData | Position | LiquidityProvision | Vote | Transfer | Proposal

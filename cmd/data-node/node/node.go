...
type NodeCommand struct {
	...
	multiSigSignerAddedStoreSQL   *sqlstore.ERC20MultiSigSignerAdded
	multiSigSignerRemovedStoreSQL *sqlstore.ERC20MultiSigSignerRemoved
	...
	multiSigSignerAddedSubSQL   *sqlsubscribers.ERC20MultiSigSignerAdded
	multiSigSignerRemovedSubSQL *sqlsubscribers.ERC20MultiSigSignerRemoved
...
func (l *NodeCommand) createGRPCServer(config api.Config, useSQLStores bool) *api.GRPCServer {
	grpcServer := api.NewGRPCServer(
		...
		l.multiSigSignerRemovedStoreSQL,
	)
	return grpcServer
}

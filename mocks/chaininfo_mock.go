...
// Source: code.vegaprotocol.io/data-node/storage (interfaces: ChainInfoI)
...
// ReloadConf mocks base method
func (m *MockChainInfoI) ReloadConf(arg0 storage.Config) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ReloadConf", arg0)
}

// ReloadConf indicates an expected call of ReloadConf
func (mr *MockChainInfoIMockRecorder) ReloadConf(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReloadConf", reflect.TypeOf((*MockChainInfoI)(nil).ReloadConf), arg0)
}

...
func testRewardsCursorPaginationNoPagination(t *testing.T) {
	...
	connectionData := rs.GetByCursor(ctx, &partyID, &assetID, pagination)
	...
	assert.Equal(t, int64(637), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(1027), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
...
func testRewardsCursorPaginationFirstPage(t *testing.T) {
	...
	assert.Equal(t, int64(637), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(643), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
	assert.Equal(t, entities.PageInfo{
		HasNextPage:     true,
		HasPreviousPage: false,
		StartCursor:     entities.NewCursor(entities.RewardCursor{PartyID: partyID, AssetID: assetID, EpochID: 637}.String()).Encode(),
...
func testRewardsCursorPaginationLastPage(t *testing.T) {
	...
	assert.Equal(t, int64(10), connectionData.TotalCount)
	assert.Equal(t, 3, len(connectionData.Entities))
	assert.Equal(t, int64(757), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(1027), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
	assert.Equal(t, entities.PageInfo{
		HasNextPage:     false,
...
func testRewardsCursorPaginationFirstPageAfter(t *testing.T) {
	...
	assert.Equal(t, int64(10), connectionData.TotalCount)
	assert.Equal(t, 3, len(connectionData.Entities))
	assert.Equal(t, int64(737), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(744), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
	assert.Equal(t, entities.PageInfo{
		HasNextPage:     true,
		HasPreviousPage: true,
...
func testRewardsCursorPaginationLastPageBefore(t *testing.T) {
	...
	assert.Equal(t, int64(10), connectionData.TotalCount)
	assert.Equal(t, 3, len(connectionData.Entities))
	assert.Equal(t, int64(741), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(747), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
	assert.Equal(t, entities.PageInfo{
		HasNextPage:     true,
		HasPreviousPage: true,
...
func testRewardsCursorPaginationNoPaginationNewestFirst(t *testing.T) {
	...
	assert.Equal(t, int64(10), connectionData.TotalCount)
	assert.Equal(t, 10, len(connectionData.Entities))
	assert.Equal(t, int64(1027), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(637), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
	assert.Equal(t, entities.PageInfo{
		HasNextPage:     false,
		HasPreviousPage: false,
...
func testRewardsCursorPaginationFirstPageNewestFirst(t *testing.T) {
	...
	assert.Equal(t, 3, len(connectionData.Entities))
	assert.Equal(t, int64(1027), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(757), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
	assert.Equal(t, entities.PageInfo{
		HasNextPage:     true,
		HasPreviousPage: false,
		StartCursor:     entities.NewCursor(entities.RewardCursor{PartyID: partyID, AssetID: assetID, EpochID: 1027}.String()).Encode(),
...
func testRewardsCursorPaginationLastPageNewestFirst(t *testing.T) {
	...
	assert.Equal(t, int64(10), connectionData.TotalCount)
	assert.Equal(t, 3, len(connectionData.Entities))
	assert.Equal(t, int64(643), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(637), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
	assert.Equal(t, entities.PageInfo{
		HasNextPage:     false,
		HasPreviousPage: true,
...
func testRewardsCursorPaginationFirstPageAfterNewestFirst(t *testing.T) {
	...
	assert.Equal(t, int64(10), connectionData.TotalCount)
	assert.Equal(t, 3, len(connectionData.Entities))
	assert.Equal(t, int64(747), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(741), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
	assert.Equal(t, entities.PageInfo{
		HasNextPage:     true,
		HasPreviousPage: true,
...
func testRewardsCursorPaginationLastPageBeforeNewestFirst(t *testing.T) {
	...
	assert.Equal(t, int64(10), connectionData.TotalCount)
	assert.Equal(t, 3, len(connectionData.Entities))
	assert.Equal(t, int64(744), connectionData.Entities[0].EpochID)
	assert.Equal(t, int64(737), connectionData.Entities[len(connectionData.Entities)-1].EpochID)
	assert.Equal(t, entities.PageInfo{
		HasNextPage:     true,
		HasPreviousPage: true,

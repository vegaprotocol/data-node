...
func NewConnectionSource(log *logging.Logger, conf ConnectionConfig) (*ConnectionSource, error) {
...
func (s *ConnectionSource) CommitTransactionForContext(ctx context.Context) error {
	if s.conf.UseTransactions {
